...
class Lexer:
  ...
  def make_tokens(self):
    ...
    while self.current_char != None:
      ...
      elif self.current_char in LETTERS or self.current_char == ':':
  ...
  def make_identifier(self):
    ...
    while self.current_char != None and self.current_char in LETTERS_DIGITS + '_' or self.current_char == ':':
...
class Parser:
  ...
  def statement(self):
    ...
    if res.error:
      return res.failure(InvalidSyntaxError(
        self.current_tok.pos_start, self.current_tok.pos_end,
        "Expected 'RETURN', 'CONTINUE', 'BREAK', 'VAR', 'IF', 'WHILE', 'FUN', int, float, identifier, '+', '-', '(', '[' or 'NOT'"
      ))
